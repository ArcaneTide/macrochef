...
const dict = {
  ...
  "No clients match search": { en: "No clients match your search.", el: "Δεν βρέθηκαν πελάτες." },
  ...
  "Nothing yet":             { en: "No activity yet",         el: "Δεν υπάρχει δραστηριότητα ακόμη." },
  "Recent activity empty hint": { en: "Your recent recipes and clients will appear here.", el: "Οι πρόσφατες συνταγές και πελάτες σου θα εμφανιστούν εδώ." },
