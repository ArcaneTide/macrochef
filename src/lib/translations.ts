...
const dict = {
  ...
  "Meals":                   { en: "Meals",                   el: "Γεύματα" },
  "Active Slots":            { en: "Active Slots",            el: "Ενεργές Θέσεις" },
  "Slot distribution":       { en: "Distribution %",          el: "Κατανομή %" },
  "Distributions must sum to 100%": { en: "Percentages must sum to 100%", el: "Τα ποσοστά πρέπει να αθροίζουν 100%" },
  "Remaining":               { en: "Remaining",               el: "Υπόλοιπο" },
  "Planned":                 { en: "Planned",                 el: "Προγρ." },
  "Slot budget":             { en: "Slot budget",             el: "Προϋπ. θέσης" },
  "Day impact":              { en: "Day impact",              el: "Επίπτωση ημέρας" },
  "Slot fit":                { en: "Slot fit",                el: "Βαθμός θέσης" },
  "Slot fit help":           { en: "How closely this matches the slot macro budget", el: "Πόσο ταιριάζει με τον στόχο θέσης" },
  "of":                      { en: "of",                      el: "από" },
  "Suggested":               { en: "Suggested",               el: "Προτεινόμενο" },
  "servings":                { en: "servings",                el: "μερίδες" },
