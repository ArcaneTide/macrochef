...
export const metadata = { title: "Client — MacroΠie" };
    ...
    <div className="py-5 sm:py-6">
      <div className="mb-6">
        <nav className="flex items-center gap-1 text-sm text-slate-400 dark:text-[#6A6460] mb-1.5">
          ...
          <span className="text-slate-600 dark:text-[#C0B8B0] font-medium">{client.name}</span>
        </nav>
        <h1 className="text-2xl font-sans font-bold text-slate-900 dark:text-[#F5F1EB]">{client.name}</h1>
      </div>
      <ClientDetail
        client={{
          id: client.id,
